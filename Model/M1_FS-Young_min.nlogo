...
to fisherskellam-step
  ...
  ask patches
  [
    set population max list 0  (population + Δ * patch-laplacian + α  * population * (1 - population / carrying-capacity))
  ]
  color-patches-FS
end
...
Arnaud Banos et Florent Le Néchet, Projet TransMonDyn
